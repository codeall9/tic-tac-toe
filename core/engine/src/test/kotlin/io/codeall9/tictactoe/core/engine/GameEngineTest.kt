...
internal class GameEngineTest {
    ...
    val newGame: LaunchTicTacToe = initLocalGame
    ...
    inner class GamePlay {
        ...
        fun playerMove(player: Player) = runTest {
